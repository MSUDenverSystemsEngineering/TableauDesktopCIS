...
Try {
	...
	[string]$appName = 'Desktop for CIS'
	[string]$appVersion = '2022-4-0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '1/14/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'tableau' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\TableauDesktop-64bit-2022-4-0.exe" -Parameters "ACCEPTEULA=1 AUTOUPDATE=0 REMOVEINSTALLEDAPP=1 /quiet /norestart" -WindowStyle "Hidden" -WaitForMsiExec
		...
		Execute-Process -Path "$envProgramFiles\Tableau\Tableau 2022.4\bin\tableau.exe" -Parameters "-activate TCQP-235B-D630-6AB4-2766"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'tableau' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$dirFiles\TableauDesktop-64bit-2022-4-0.exe" -Parameters "/uninstall /quiet"
	...
	ElseIf ($deploymentType -ieq 'Repair')
	{
		...
		Execute-Process -Path "$dirFiles\TableauDesktop-64bit-2022-4-0.exe" -Parameters "/repair /quiet"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCkbnSw3JLCClqq
# dBe7hda/oRTDiR/wh0zCHvMkkYlBI6CCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQguCUCIqkIIfzb
# DIPvSXh4xmdclDTTokl+zT16okGGdvcwDQYJKoZIhvcNAQEBBQAEggGAEDNJf4G4
# TgW9W+yIPcMvo5CJjJEdJdVi/3rNpjTVNd0S+ZOVkMwel0WuXj/KjsmOBhnRuk3l
# daGCiRaV8ehdAxP55/mld1uwoQfWVWFAda8KubA1BC1XB4vPS6Kbmpd++OOQf+WY
# p6IOJZQpmSY09jDJU0BA6U/SI3FmLOYRA1/AhaFfp6EYf8TluP2nommMz+3mxvtU
# geNxTvDjj8aehLjcRVCJbWMZXdalB7YrQLYnVo7zTrQDce2cnKnLgHtzHjlOFxZ3
# nPNMAqqzyGhhJ8u/I5AoJVlzJCHfIL6lU9BZjb4thcV2fOtNDwW6EpX60RRQhs1K
# ep03yDC1naKkMyvevEraOIaCnOCMKIhEWw/21ST1sHts3jtq7UZFSoFMsXKBbhfo
# ciC7F/G3pTas7grcRdPTnjUhPk2/CbzhVVmqagm0/YFJvxEHFjS1fLdGeIdahTZW
# qihYzlwrm8wgTRoryh7Ml7bYcMLB9+FmVTQvN9aPJRaQ3d+aKNdYO81BoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzAxMTUw
# MDAyMzVaMD8GCSqGSIb3DQEJBDEyBDA6JMC7iWNa2wZINpCSD3Qemh9skfoGG85u
# SJlk/wd1xm9/bqJRgFcYtuDHUKdbbYAwDQYJKoZIhvcNAQEBBQAEggIAUPZ6+HF/
# u3WCFkT8Yn41mSulI/pIz1GLRiw5xlplxPDyLji+ujYPRNummUbqkImXhSVaaspR
# U6sj9Efdiac1Nqj5MdrNPFu7K43zD4Qc3lupK+iXYc4WU7oODnRiVicbnJwsv63h
# 0gAAYxQ37xSZA8E3R2izpClzic7pPVPXlT0YLKhKCPNOKZeHdjl7TGS+/jt9s6pu
# RnVPGl4gjFmD6kIiqDMuo3XCehFlxVWuFIAk3LGx49qEXWhBtE5hZqIP2saXabUV
# enjFZCECYJM2HFD7Ra5CABaHoRaMKpI2BCmsexUabFgpHXXYgqL4rBngTFGIvFLF
# rNnnoP3S3rsCGC4Gw+YiaS2uxLhLWA0KbG/mL7R8zAC4GvN617wS+bRD1+vCxHno
# I91ECFLwycbleR6VWEE28UJLgI7iJoQxGIY1ph5IeS8g511Kvcks15kVoUNrIy56
# 79tya2gK+ZButk41D+V886ROiTlX4v16foLttLp9QLiQn1rj9famaTS5i7zHksxb
# ytqaWwbX+4F23GCGy2zE7YqGGxz9+sVsP/WRHBFNUzptNT9abJn62v8U568q6XMg
# oxGQXgNUFblgwmTMvKiCRRq95dqVxr/CNNXLTUjkQHtn9tDkMV2P9Hf/F0jKSLV1
# L5J/jFP3qFy9WxDnNBszVl5+97JiyQiy3UE=
